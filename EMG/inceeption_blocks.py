...
class Inception_block(nn.Module):
    def __init__(self,in_channels,out_1x1,red_3x3,out_3x3,red_5x5,out_5x5,out_1x1pool):
        ...
        self.branch4=nn.Sequential(
            ...
            Conv_Block(in_channels,out_1x1pool,kernel_size=1)#######################3
        )

    def forward(self,x):
        print("inception")
        # No_of images sent in X no_of_filters X 28X28
...
if __name__ =="__main__":
    x=torch.randn(1,192,244,244)#batch ,channel
    # model=Conv_Block(1,30,kernel_size=1)

    model=Inception_block(192,64,96,128,16,32,32)
    print(model(x).shape)